        ...
        <div className="flex flex-col md:flex-row items-end gap-8 mb-12">
          ...
          <div className="pb-4 flex space-x-4">
            {isOwnProfile ? (
              ...
              <>
                <button className="px-8 py-3 bg-emerald-500 text-black font-bold rounded-full hover:bg-emerald-400 transition-colors">
                  Connect
                </button>
                <button className="px-8 py-3 bg-white/5 border border-white/10 text-white font-bold rounded-full hover:bg-white/10 transition-colors">
                  Message
                </button>
              </>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pb-24">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-8">
              ...
              {isOwnProfile && (
                <button className="p-2 bg-emerald-500 text-black rounded-xl hover:bg-emerald-400 transition-colors">
